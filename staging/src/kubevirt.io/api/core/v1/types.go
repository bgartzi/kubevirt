...
type InterfaceBindingPlugin struct {
	...
	// lock rlimit requirements by means of a a boolean flag and an
	// offset.
	...
	// memory lock rlimits per each network binding plugin plugin type
	// attached to the vmi.
	// version: v1alphav1
	// +optional
...
// lock rlimit configuraiton requirements
